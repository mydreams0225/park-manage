          ...
          <el-row>
             <el-col :span="6" v-for="(o, index) in 12" :key="o" >
               <el-card  class="fatherImg">
                  ...
                  <img src="http://pic.people.com.cn/NMediaFile/2018/0619/MAIN201806191422000284134827157.jpg" class="image">
                  <div class="info">
                     <p class="l">粤A9M33 临时车</p>
                     <p class="r">2018--3-3 4：13:4停车·</p>
                  </div>
               </el-card>
             </el-col>
          </el-row>
