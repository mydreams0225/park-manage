          ...
          <!-- 读卡操作 -->
           ...
           <el-row :gutter="20">
                  ...
                  <el-card class="box-card" >
                    ...
                    <div class="memo sshy">
                          <el-row :gutter="24">
                                <el-col :span="12">
                                  <div >
                                  <span>所属业主：（点击选择，x清除）<a href="#" @click="addOwner" >[点击添加业主信息]</a> </span>
                                  <el-input :value="tab1.carOwnerValue" v-on:click.native="carOwnerVisible = true"  placeholder="点击选择" readonly="readonly" ></el-input>
                                      <el-dialog title="选择所属业主"  :visible.sync="carOwnerVisible" width="550px" >
                                              ...
                                              <el-table :data="homeOwnerData" @row-click="carOwnerCheck" ref="clientTable">
             ...
             <el-col :span="6">
                 ...
                 <div v-show="ownerCardShow" class="newCar ownerGroup" >
                  <el-card class="box-card" >
                    <div slot="header" class="clearfix" >
                      <span >添加业主信息</span>
                    ...
                    <div >
                      <el-row :gutter="20">
                         <el-col :span="8">
                           <span class="mustshuru">*</span><span>姓名：</span>
                           <div><el-input v-model="tab1.owner.name"></el-input></div>
                         </el-col>
                         <el-col :span="8">
                           <span class="mustshuru">*</span> <span>性别：</span>
                           <div><el-select v-model="tab1.owner.sex" placeholder="请选择">
                            <el-option
                              v-for="item in sels.sex"
                              :key="item.value"
                              :label="item.label"
                              :value="item.value">
                            </el-option>
                         ...
                         <el-col :span="8">
                           <span>住户分组</span>
                           <div><el-input v-model="tab1.owner.ownerGroup"></el-input></div>
                         </el-col>
                      </el-row>
                      <el-row :gutter="20">
                         <el-col :span="8">
                           <span class="mustshuru">*</span><span>手机：</span>
                           <div><el-input v-model="tab1.owner.phone"></el-input></div>
                         </el-col>
                         <el-col :span="8">
                           <span class="mustshuru">*</span> <span>住址：</span>
                           <div><el-input v-model="tab1.owner.phone"></el-input></div>
                         </el-col>
                      ...
                      <el-row :gutter="20">
                         <el-col :span="24">
                           <span class="mustshuru">*</span><span>备注：</span>
                           <div class="ownerMemo"><el-input v-model="tab1.owner.memo"></el-input></div>
                         </el-col>
                        
                         
                      </el-row>
                      <div class="ownerSave"> <el-button type="primary" @click="addownerinfo">保存</el-button></div>
           ...
           <div class="font" style="margin-top:15px">
              <el-row :gutter="20">
                <el-col :span="6">
                  ...
                  <template>
                    <el-select v-model="tab2Park" placeholder="请选择">
                      <el-option
                        v-for="item in sels.park"
                        :key="item.value"
                        :label="item.label"
...
import { postFile, reqEdit,reqAddOwnerInfo } from "@/api/carManage";
export default {
  data() {
    return {
...
ownerCardShow:false,
      ...
      homeOwnerData: configs.homeOwner,
      valid: {
        car_no: false
      },
      tab1: {
  ...
  methods: {
    //添加业主信息显示界面
    addOwner(){
      this.ownerCardShow=true;
    },
    //保存业主信息
    addownerinfo(){
      var  owner=this.tab1.owner;
      ...
      reqAddOwnerInfo(para).then(res=>{
        if(res.code===1){
           this.$message({
                message: "业主添加成功！",
                type: "success"
              });
              this.ownerCardShow=false;
        }
      })
    },
    carNoChange(value) {
